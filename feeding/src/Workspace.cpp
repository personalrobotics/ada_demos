...
Workspace::Workspace(aikido::planner::WorldPtr& world, const Eigen::Isometry3d& robotPose, bool adaReal, const ros::NodeHandle& nodeHandle) : world(world) {
  ...
  addToWorld(workspaceEnvironment, "workspaceEnvironment", robotPose, nodeHandle);
...
void Workspace::addToWorld(dart::dynamics::SkeletonPtr& skeleton, std::string name, const Eigen::Isometry3d& robotPose, const ros::NodeHandle& nodeHandle) {
