...
//==============================================================================
void correctttForkTip(const geometry_msgs::Pose2D::ConstPtr& msg)
{
...

{
  ...
  mDefaultEETransform = joint->getTransformFromParentBodyNode();
...
void Perception::correctForkTip(const geometry_msgs::Pose2D::ConstPtr& msg)
{
  ...
  for (auto point : imagePoints) {
    ...
    cv::circle(img, point, 3, cv::Scalar(255, 255, 255, 255), 5);
  }
