...
class Workspace {
  ...
  void addToWorld(dart::dynamics::SkeletonPtr& skeleton, std::string name, aikido::planner::WorldPtr world, const Eigen::Isometry3d& robotPose, const ros::NodeHandle& nodeHandle);

public:
  Workspace(aikido::planner::WorldPtr world, const Eigen::Isometry3d& robotPose, const ros::NodeHandle& nodeHandle);
