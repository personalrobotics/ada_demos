#ifndef FEEDING_GOALPOSECONTROLLERBASE_HPP_
#define FEEDING_GOALPOSECONTROLLERBASE_HPP_
...
namespace feeding
{
class GoalPoseControllerBase
{
protected:
  using Action = ada_demos::SetGoalPoseAction;
  using ActionServer = actionlib::ActionServer<Action>;
  using GoalHandle = ActionServer::GoalHandle;

  using Feedback = ada_demos::SetGoalPoseActionFeedback;
  using Result = ada_demos::SetGoalPoseActionResult;

  GoalPoseControllerBase();
  virtual ~GoalPoseControllerBase();
...
private:
  ...
  rewd_controllers::JointAdapterFactory mAdapterFactory;
  dart::dynamics::SkeletonPtr mSkeleton;
  dart::dynamics::MetaSkeletonPtr mControlledSkeleton;
  std::shared_ptr<aikido::statespace::dart::MetaSkeletonStateSpace>
      mControlledSpace;

  std::unique_ptr<rewd_controllers::SkeletonJointStateUpdater> mSkeletonUpdater;
  std::vector<std::unique_ptr<rewd_controllers::JointAdapter>> mAdapters;
...
#endif  // ifndef FEEDING_GOALPOSECONTROLLERBASE_HPP_
